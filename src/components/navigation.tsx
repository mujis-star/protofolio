...
export function Navigation() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl transition-all duration-300 rounded-full border border-white/10 ${
        scrolled
          ? "bg-black/40 backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.8)]"
          : "bg-white/5 backdrop-blur-md shadow-[0_5px_20px_rgba(0,0,0,0.5)]"
      }`}
    >
