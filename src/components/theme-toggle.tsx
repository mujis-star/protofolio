...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-10 h-10 border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black/50 backdrop-blur-md transition-all hover:bg-neutral-100 dark:hover:bg-neutral-900"
    >
